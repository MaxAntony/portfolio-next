  ...
  return (
    <div className='group mb-24 '>
      <div className='grid grid-cols-11 items-center gap-2'>
        <div
          className={`col-start-1 col-end-12 w-full rounded border bg-white bg-contain bg-center 
          bg-no-repeat shadow grayscale transition-all duration-500 hover:z-20 hover:grayscale-0
          lg:col-start-6 lg:col-end-[-1] lg:row-start-1 lg:row-end-[-1] lg:group-odd:col-start-1
          lg:group-odd:col-end-8`}
        >
          <Image src={project.image} width={2000} height={2000} alt={`projecto ${project.title}`} />
        </div>
        <div
          className={`col-start-1 col-end-12 lg:z-10 lg:col-start-1 lg:col-end-[7] lg:row-start-1
          lg:row-end-[-1] lg:group-odd:col-start-7 lg:group-odd:col-end-[-1] lg:group-odd:text-right`}
        >
          ...
          <button
            name='ver mas'
            className={`hidden border-2 border-gray-700 p-2 transition duration-300
